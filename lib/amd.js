      ...
      for (mek of _0x1071af.messages) {
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|kevoo/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
...
<div class="bounce-text">kevoomedia</div>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/kevoo;;;/gi, "").replace(/Astro;;;/gi, "").replace(/Kevoomedia;;;/gi, "").trim();
